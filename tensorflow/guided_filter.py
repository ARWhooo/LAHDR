# From Github: https://github.com/wuhuikai/DeepGuidedFilter
...
def fast_guided_filter(lr_x, lr_y, hr_x, r, eps=1e-8, nhwc=True):
    ...
    mean_A = tf.image.resize_bilinear(A, hr_x_shape[2:])
    mean_b = tf.image.resize_bilinear(b, hr_x_shape[2:])
